...
date: 2025-05-19 13:21:02
lastmod: 2025-05-19 13:31:29
categories: 
tags:
  - javascript
aliases: 
...
🇬🇧 [English](30%20Days%20Of%20JavaScript.md)
...
<mark style="background: #ABF7F7A6;">For a variable that changes at a different time, we use <em>let</em>. If the data does not change at all, we use <en>const</em>.</mark> For example, PI, country name, gravity do not change, and we can use _const_. <mark style="background: #BBFABBA6;">We will not use var in this challenge and I don't recommend you to use it. It is error prone way of declaring variable it has lots of leak.</mark> We will talk more about var, let, and const in detail in other sections (scope). For now, the above explanation is enough.
