...
<mark style="background: #ABF7F7A6;"><em>Primitive</em> data types are immutable(non-modifiable) data types. Once a primitive data type is created we cannot modify it.</mark>
...
<mark style="background: #ABF7F7A6;">Rule of thumb, we do not compare non-primitive data types. Do not compare arrays, functions, or objects.</mark>
...
<mark style="background: #BBFABBA6;">Everything in JavaScript is an object.</mark> A string is a primitive data type that means we can not modify it once it is created. The string object has many string methods. There are different string methods that can help us to work with strings.
...
17. <mark style="background: #ABF7F7A6;"><em>match</em>: it takes a substring or regular expression pattern as an argument and it returns an array if there is match if not it returns null.</mark> Let us see how a regular expression pattern looks like. ==It starts with / sign and ends with / sign.==
